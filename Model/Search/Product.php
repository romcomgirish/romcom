...
namespace Vihadigitalcom\SearchSuiteAutocomplete\Model\Search;
...
use \Vihadigitalcom\SearchSuiteAutocomplete\Model\Source\AutocompleteFields;
use \Vihadigitalcom\SearchSuiteAutocomplete\Model\Source\ProductFields;

/**
 * Product model. Return product data used in search autocomplete
 */
class Product implements \Vihadigitalcom\SearchSuiteAutocomplete\Model\SearchInterface
{
    /**
    ...
    {
        /** @var \Vihadigitalcom\SearchSuiteAutocomplete\Block\Autocomplete\Product $product */
        $product = $this->objectManager->create('Vihadigitalcom\SearchSuiteAutocomplete\Block\Autocomplete\ProductAgregator')
            ->setProduct($product);
