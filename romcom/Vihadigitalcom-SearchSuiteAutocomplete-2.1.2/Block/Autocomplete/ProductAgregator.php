...
namespace Vihadigitalcom\SearchSuiteAutocomplete\Block\Autocomplete;

use \Vihadigitalcom\SearchSuiteAutocomplete\Block\Product as ProductBlock;
...
{
    /**
     * @var \Vihadigitalcom\SearchSuiteAutocomplete\Block\Product
     */
    ...
    {
        $formUrl = $this->productBlock->getAddToCartUrl($this->getProduct(), ['vihadigitalcom_searchsuiteautocomplete' => true]);
